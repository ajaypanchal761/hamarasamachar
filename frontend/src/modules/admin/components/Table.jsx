        ...
        <div className="p-3 sm:p-4 border-b border-gray-200">
          <div className="relative">
            <input
              ...
              className="w-full px-4 py-2 pl-10 text-sm sm:text-base border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:border-orange-600 focus:ring-orange-500 transition-colors"
            />
            <svg
          ...
          <thead>
            <tr className="bg-gray-50 border-b border-gray-200">
              {columns.map((column) => (
                <th
                  key={column.key}
                  className={`px-3 sm:px-4 md:px-6 py-3 text-left text-xs sm:text-sm font-semibold text-gray-700 ${
              ...
              {actions.length > 0 && (
                <th className="px-3 sm:px-4 md:px-6 py-3 text-left text-xs sm:text-sm font-semibold text-gray-700">
                  कार्रवाई
                </th>
              )}
            </tr>
