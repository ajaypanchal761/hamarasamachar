        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-4 sm:space-y-5 mb-6 sm:mb-8">
            ...
            <div className="space-y-4 sm:space-y-5">
              ...
              <div className="bg-[#E21E26]/5 rounded-lg p-4 sm:p-5 border-l-4 border-[#E21E26]">
                <h3 className="text-base sm:text-lg font-bold text-gray-900 mb-2">
                  8. सूचना एवं योजनाओं की आधिकारिक जानकारी
                </h3>
                <p className="text-sm sm:text-base text-gray-700 leading-relaxed">
                "हमारा समाचार" दैनिक समाचार पत्र के प्रिंट व डिजिटल एडिशन में किसी भी प्रकार की कोई योजना शुरू होगी वो भी जनता जनार्दन को हमारे द्वारा लिखित में नोटिफिकेशन के द्वारा भेजी जा सकेगी,जिससे कि सभी लोग फायदा ले सकें। जिसमें कई प्रकार की गिफ्ट योजना,इनामी योजना, विज्ञापन योजना,डिजिटल एडिशन में विज्ञापन योजना,प्रिंट में समाचार पत्र में सदस्यता गिफ्ट योजना, पब्लिक कोई लेख देना चाहे,कोई आप बीती बताना चाहे,किसी प्रकार का कोई केस हो जिससे वह परेशान हो, सरकार के किसी भी विभाग की जानकारियां पब्लिश को मिलती रहेगी, अन्य कई प्रकार की योजनाएं जो आप लोगों तक व्हाट्सएप msg या text msg के द्वारा पहुंचाई जाएगी।
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="mb-6 sm:mb-8">
            ...
            <div className="bg-white border border-gray-200 rounded-lg p-4 sm:p-5 hover:shadow-md transition-shadow">
              ...
              <button
                onClick={() => handlePhoneClick('+91-8824839740')}
