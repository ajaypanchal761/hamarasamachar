  ...
  return (
    <div className="min-h-screen bg-white pb-20 sm:pb-24">
      ...
      <div className="sticky top-0 z-10 bg-white flex items-center justify-between px-2.5 sm:px-3 py-2 sm:py-2.5 border-b border-gray-200">
        ...
        <h2 className="text-sm sm:text-base font-bold text-gray-800">फीडबैक</h2>
            ...
            <div>
              ...
              <div className="space-y-3">
                ...
                <button
                  ...
                  className="w-full flex items-center gap-3 p-3 border-2 border-gray-200 rounded-lg hover:border-orange-500 hover:bg-orange-50 transition-colors text-left"
                >
